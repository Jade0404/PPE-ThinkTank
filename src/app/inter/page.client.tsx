...
export default function InterPageContent() {
  ...
  useEffect(() => {
    console.log("🚀 InterPageContent: Loading data...");
  ...
  console.log("  searchResults sample:", searchResults.slice(0, 2).map(c => ({ course_id: c.course_id, name_en: c.name_en })));
                        ...
                        return (
                          ...
                          >
                            ...
                            <p className="text-sm text-gray-600">
                              {courseDocCount} {courseDocCount === 1 ? "file" : "files"}
                            </p>
                          </button>
                        );
                      })}
